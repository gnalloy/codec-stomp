# ADR-001: Keep codec-stomp as an Independent Gnalloy Module
...
`codec-stomp` is published as `gnalloy.org/codec-stomp` and owns this responsibility: STOMP frame codecs and header encoding helpers for Gnalloy pipelines.
