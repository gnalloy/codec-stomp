...
- Import path: `gnalloy.org/codec-stomp`
- Repository: `github.com/gnalloy/codec-stomp`
- Default branch: `dev`
- Preview install: `go get gnalloy.org/codec-stomp@dev`
- License: Apache-2.0
...
This repository owns: STOMP frame codecs and header encoding helpers for Gnalloy pipelines.
